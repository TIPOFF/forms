...
namespace Tipoff\Forms\Tests\Feature\Nova;
...
class ContactResponseResourceTest extends TestCase
{
    use DatabaseTransactions;

    private const NOVA_ROUTE = 'nova-api/contact-responses';
    ...
    {
        ContactResponse::factory()->count(4)->create();
    ...
    public function delete_by_role(?string $role, bool $hasAccess, bool $canDelete)
    {
        ...
        $this->assertDatabaseCount('contact_responses', $canDelete ? 0 : 1);
    }
